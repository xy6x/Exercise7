...
public class math {
    ...
    public static void ent() throws InputMismatchException {
    ...
    public static void ran() throws InputMismatchException{
        Scanner s = new Scanner(System.in);
...
//
    ...
    public static void num() throws InputMismatchException{
        Scanner s =new Scanner(System.in);
       try {
